...
public class JedisPool extends Pool<Jedis> {
  ...
  public JedisPool(String host, int port, boolean ssl) {
    this(new GenericObjectPoolConfig(), host, port, Protocol.DEFAULT_TIMEOUT, null,
        Protocol.DEFAULT_DATABASE, null, ssl);
  }
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final String host, int port,
      int timeout, final String password, final int database, final String clientName, boolean ssl) {
  ...
  public JedisPool(final GenericObjectPoolConfig poolConfig, final URI uri,
    ...
    super(poolConfig, new JedisFactory(uri, connectionTimeout, soTimeout, null,
            (uri.getScheme() !=null && uri.getScheme().equals("rediss"))));
  }
